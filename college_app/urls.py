...
from . import views
from college_app.views import Update_job,Delete_job
#from college_app.views import job_detail, Update_job,Delete_job,my_candidates,job_matching,search_candidates,campus_hiring,add_a_blog,assessments,recruiter_blog,applicant_detail


app_name = 'college'

urlpatterns = [
    path("create-college-user-profile/",
         views.createprofile, name="create_college_profile"),
    ...
    path("college-app/profile/",views.profile,name="profile"),
